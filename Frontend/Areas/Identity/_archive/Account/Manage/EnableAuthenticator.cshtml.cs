...
namespace SarasBlogg.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", "Verifieringskoden är ogiltig.");
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            _logger.LogInformation("Användare med ID '{UserId}' har aktiverat 2FA med en autentiseringsapp.", userId);
